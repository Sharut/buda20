...
data_en_v1=pd.read_csv(loc_data + 'clean_en_data_v1.tsv', delimiter='\t',
                      encoding='utf-8')
data_en_v2=pd.read_csv(loc_data + 'clean_en_data_v2.tsv', delimiter='\t',
                      encoding='utf-8')
data_en_tw_cons=pd.read_csv(loc_data + 'en_data_tweet_consist.tsv', delimiter='\t',
                      		encoding='utf-8')
...
result_en.to_csv('NLP/PAN20/data/en_ensemble_train.tsv', sep='\t', index=False)
...
result_en_v2.to_csv('NLP/PAN20/data/en_ensemble_dev.tsv', sep='\t', index=False)
